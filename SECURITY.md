...
1. If you have access to repository security advisories, open a draft advisory in GitHub.
2. Otherwise, open a repository issue and clearly mark it as a **security report**.
3. If the issue includes PBInfo sessions, cookies, local archive paths, or other sensitive reproduction details, minimize the data and redact secrets before sharing it.
